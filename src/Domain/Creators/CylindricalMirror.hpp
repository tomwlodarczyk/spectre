...
class CylindricalMirror : public DomainCreator<3> {
 public:
  ...
  using options =
      tmpl::list<PartitionInRadius, RefLevSquare, GridPointsSquare,
                 RefLevRadius, GridPointsRadius, RefLevTheta, GridPointsTheta,
                 PartitionInZ, RefLevZ, GridPointsZ, UseEquiangularMap>;
